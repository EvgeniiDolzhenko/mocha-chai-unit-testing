...
function checkThreeAndTwo(array) {
  ...
  for(let i = 0; i < array.length; i++){
   ...
   if(a == 3 && b == 2 || a == 2 && b == 3 || c == 3 && b == 2 || b == 3 && c == 2 || a == 2 && c == 3 || a == 3 && c == 2) return true
   return false
 }


module.exports = {inAscOrder,checkThreeAndTwo,toJadenCase,solution,reverseNumber,flattenAndSort,greet,solve, removeDuplicateWords,largestPairSum,evenNumbers,smallEnough,fizzbuzz7,vowelIndices, getEvenNumbers} 